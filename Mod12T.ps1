...
if (-Not (Test-Path .\archives_Hamilton))
{
    mkdir .\archives_Hamilton | out-Null
}
...
$zipfile = @{
    ...
    DestinationPath = ".\archives_Hamilton\empdata01"
}
...
if (-Not (Test-Path .\extracted_files_Hamilton))
{
    mkdir .\extracted_files_Hamilton | out-Null
}

#unzip the csv file into the extracted_file subdirectory
Expand-Archive -Path .\archives_Hamilton\empdata01.zip -DestinationPath .\extracted_files_Hamilton -Force
